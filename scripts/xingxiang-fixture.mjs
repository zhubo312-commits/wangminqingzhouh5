...
const transformations = [{ transformation: "禄", star: "巨门" }, { transformation: "权", star: "太阳" }, { transformation: "科", star: "文曲" }, { transformation: "忌", star: "文昌" }];
...
export const xingxiangChart = {
  ...
  palaces: branches.map((branch, index) => ({
    ...
    selfTransformations: index === 0 ? [{ transformation: "忌", star: "廉贞", inward: false }] : index === 1 ? [{ transformation: "科", star: "天机", inward: true }] : [],
  })),
