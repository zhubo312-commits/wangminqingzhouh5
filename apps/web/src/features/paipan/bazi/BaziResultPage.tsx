...
import { ArrowClockwise, CalendarDots, CaretRight, ChatCircleDots, Coins, Drop, Flame, Mountains, Tree } from "@phosphor-icons/react";
import { type CSSProperties, type ReactNode, useCallback, useEffect, useMemo, useState } from "react";
import { useNavigate } from "react-router-dom";
import { PageHeader } from "../../../components/PageHeader";
import { fetchFlowMonths, fetchHome, trackEvent } from "../../../lib/api-client";
...
function InterpretationEntry({ href, placement }: {
  href: string | null;
