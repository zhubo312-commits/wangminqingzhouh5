...
describe("homepage", () => {
  ...
  it("shows exactly eleven chart entries and enables the five completed charts", async () => {
    ...
    expect(navigation.querySelectorAll('[aria-disabled="true"]')).toHaveLength(6);
    expect(screen.getAllByText("即将上线")).toHaveLength(6);
  });
