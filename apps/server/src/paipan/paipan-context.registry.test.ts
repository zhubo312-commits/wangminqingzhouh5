...
describe("paipanContextRegistry", () => {
  ...
  it("rejects unknown chart types and mismatched schema versions", () => {
    ...
    expect(isRegisteredPaipanIdentity("meihua", "guoxue.paipan.meihua.v2")).toBe(true);
    expect(isRegisteredPaipanIdentity("meihua", "guoxue.paipan.meihua.v1")).toBe(false);
    ...
    expect(isRegisteredPaipanIdentity("xingxiang", "guoxue.paipan.xingxiang.v3")).toBe(true);
    expect(isRegisteredPaipanIdentity("xingxiang", "guoxue.paipan.xingxiang.v2")).toBe(false);
